      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="btn-close" (click)="showFaqForm.set(false)"></button>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="btn-close" (click)="showServiceForm.set(false)"></button>
          </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="btn-close" (click)="showCareerForm.set(false)"></button>
          </div>
...
export class WebsiteContentComponent implements OnInit {
  ...
  onMediaSelected(mediaItems: any[]): void {
    if (mediaItems.length) {
      const imgUrl = 'http://localhost:3000/uploads/media/' + mediaItems[0].filename;
      let saveInstruction = '';
  ...
  openFaqModal(faq?: any): void {
    if (faq) {
      ...
      this.faqForm.reset({ question: '', answer: '', displayOrder: 0 });
    }
  ...
  openServiceModal(svc?: any): void {
    if (svc) {
      ...
      this.serviceForm.reset({ title: '', icon: 'bi-building', description: '' });
    }
  ...
  resolveImage(imagePath: string): string {
    ...
    if (imagePath.startsWith('/')) {
      return 'http://localhost:4200' + imagePath;
    }
    return 'http://localhost:4200/' + imagePath;
  }
}
